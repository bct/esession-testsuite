...
It was originally written as part of Google Summer of Code 2007 for the XMPP Software Foundation by Brendan Taylor[1], and is released under the MIT/X11 license (see the LICENSE file).
